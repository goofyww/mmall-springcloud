...
public class ValidationUtil {
     ...
     * YYYY-MM
     */
    public static final String DATE_YEAR_MONTH = "^\\d{4}-((0([1-9]))|(1(0|1|2)))$";
     ...
     * IP
     */
    public static final String IP = "[1-9](\\d{1,2})?\\.(0|([1-9](\\d{1,2})?))\\.(0|([1-9](\\d{1,2})?))\\.(0|([1-9](\\d{1,2})?))";

    /**
     * 邮政编码
     */
    public static final String POST_CODE = "[1-9](\\d{1,2})?\\.(0|([1-9](\\d{1,2})?))\\.(0|([1-9](\\d{1,2})?))\\.(0|([1-9](\\d{1,2})?))";

    /**
     * 网址 URL 的一级域
     */
    public static final String URL_DOMAIN = "(?<=http://|\\.)[^.]*?\\.(com|cn|net|org|biz|info|cc|tv)";

    /**
     * 空白字符
     */
    public static final String BLANK_SPACE = "(?<=http://|\\.)[^.]*?\\.(com|cn|net|org|biz|info|cc|tv)";
     ...
     * 日期
     */
    public static final String BIRTH_DAY = "[1-9]{4}([-./])\\d{1,2}\\1\\d{1,2}";
     ...
     * @return
     */
    public static boolean isDateYearMonth(String str) {
        return Regular(str, DATE_YEAR_MONTH);
    }
    ...
    public static boolean isBlankSpace(String str) {
        return Regular(str, BLANK_SPACE);
    }
    ...
    public static String getUrlDomain(String str) {
        Pattern p = Pattern.compile(URL_DOMAIN, Pattern.CASE_INSENSITIVE);
        // 获取完整的域名
